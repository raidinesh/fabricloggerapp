...
function instantiateChaincode() {
	...
	peer chaincode instantiate -o orderer.example.com:7050 --tls $CORE_PEER_TLS_ENABLED \
		...
		-v $VERSION -P "OR ('VisionmedicMSP.member','HmcMSP.member')"
}
...
createChannel "shipmenttraking"

joinChannel "peer0.visionmedic.example.com" "shipmenttraking" "VisionmedicMSP" 1
joinChannel "peer1.visionmedic.example.com" "shipmenttraking" "VisionmedicMSP" 0
joinChannel "peer0.hmc.example.com" "shipmenttraking" "HmcMSP" 1
joinChannel "peer1.hmc.example.com" "shipmenttraking" "HmcMSP" 0

packageChaincode "shipment_cc" "golang" "${CHAINCODE_VERSION}"

# Install chaincode onto peers. Do not worry about channels here.
installChaincode "peer0.visionmedic.example.com" "shipment_cc" "VisionmedicMSP" "${CHAINCODE_VERSION}"
installChaincode "peer1.visionmedic.example.com" "shipment_cc" "VisionmedicMSP" "${CHAINCODE_VERSION}"
installChaincode "peer0.hmc.example.com" "shipment_cc" "HmcMSP" "${CHAINCODE_VERSION}"
installChaincode "peer1.hmc.example.com" "shipment_cc" "HmcMSP" "${CHAINCODE_VERSION}"

# Instantiate chaincode on each channel.
instantiateChaincode "peer0.visionmedic.example.com" "shipmenttraking" "shipment_cc" "VisionmedicMSP" "${CHAINCODE_VERSION}"


# These set up channel logging to Splunk
curl -X PUT fabric-logger.example.com:8080/channels/shipmenttraking
