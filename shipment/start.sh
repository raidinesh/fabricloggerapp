...
export COMPOSE_PROJECT_NAME="shipment-tracking"
...
export visionmedic_ADMIN_PK=$(find crypto/peerOrganizations/visionmedic.example.com/users/Admin@visionmedic.example.com/msp/keystore/ -type f)
export PEER_CLIENT_PK=$(find crypto/peerOrganizations/visionmedic.example.com/peers/peer0.visionmedic.example.com/tls/server.key -type f)
